/**
 * @file leftHandNavigation.stories.js
 * @description Storybook configuration file for the leftHandNavigation component.
 * @module leftHandNavigation.stories
 */
...
export default {
    title: "!Layout/Left Hand Navigation",
    render: ( args) => {
